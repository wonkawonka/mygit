...
parser.add_argument('--data', type=str, default='MSL', help='data')
...
for ii in range(args.itr):
    setting = '{}_{}_ft{}_sl{}_ll{}_pl{}_nl{}_dm{}_nh{}_el{}_dl{}_df{}_at{}_eb{}_{}_{}'.format(args.model, args.data,
                                                                                               args.features,
                                                                                               args.seq_len,
                                                                                               args.label_len,
                                                                                               args.pred_len,
                                                                                               ...
                                                                                               args.n_heads,
                                                                                               args.e_layers,
                                                                                               args.d_layers, args.d_ff,
                                                                                               args.attn, args.embed,
                                                                                               args.des, ii)
