...
parser.add_argument('--model', type=str, default='vrae', help='model of the experiment')

parser.add_argument('--data', type=str, default='SMAP', help='data')
...
for ii in range(args.itr):
    setting = '{}_{}_ft{}_sl{}_eh{}_dh{}_el{}_dl{}_la{}_bl{}_{}_{}'.format(args.model, args.data, args.features,
                                                                           args.seq_len, args.enc_hid, args.dec_hid,
                                                                           args.e_layers, args.d_layers, args.d_lat,
                                                                           args.block, args.des, ii)
